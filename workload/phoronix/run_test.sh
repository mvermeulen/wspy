...
if [ $(grep -c Intel /proc/cpuinfo) -gt 0 ]; then
    ...
    /home/mev/source/wspy/wspy -o frontend.txt --topdown-frontend --no-ipc --no-software --no-rusage batch-run $TESTNAME
    /home/mev/source/wspy/wspy -o opcache.txt --topdown-optlb --no-ipc --no-software --no-rusage batch-run $TESTNAME    
